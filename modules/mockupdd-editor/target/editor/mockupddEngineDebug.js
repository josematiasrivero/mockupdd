...
var Tag = Class.extend({
	...
	getSubtagsOfType: function(tagType) {
		return _.filter(this.getSubtags(), function(tag) { return tag.getTagType() == tagType; });
	},
...
var DataManager = Class.extend({
	...
	_notifyListeners: function(objectClass) {
		if (this.objectListeners[objectClass]) {
			for (i in this.objectListeners[objectClass]) {
...
;
var DataItemTagEditor = TagEditor.extend({
...
;
var SaveTagEditor = TagEditor.extend({
